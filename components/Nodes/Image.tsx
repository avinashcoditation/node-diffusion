      ...
      <Content>
        {node.data.output.image && (
          <img
            ...
            className='rounded max-w-80 min-h-[450px] max-h-[500px]'
            alt='graph image'
            onLoad={() => setLoaded(true)}
          />
        )}
        {!node.data.output.image && !loaded && (
          <div className='aspect-square max-w-80 min-h-[450px] max-h-[500px] flex rounded bg-black/20 justify-center items-center flex-col text-neutral-600'>
            <ImageIcon size={32} />
