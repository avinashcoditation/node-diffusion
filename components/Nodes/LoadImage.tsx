      ...
      <Content>
        {node.data.output.image && (
          <img
            ...
            className='rounded max-w-80 min-h-[450px] max-h-[500px] cursor-pointer hover:opacity-80 duration-200'
            alt='graph image'
        ...
        {!node.data.output.image && !loaded && (
          <div
            className='aspect-square max-w-80 min-h-[450px] max-h-[500px] flex rounded bg-black/20 justify-center cursor-pointer items-center flex-col text-neutral-600'
            onClick={loadImage}
          >
            <ImageIcon size={32} />
